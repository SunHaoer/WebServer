...
public class HttpResponse {
	...
	private int status;				// 响应状的态码
	private String contentType;		// 响应的数据类型
	private int contentLength;		// 响应的数据长度
	private OutputStream outputStream;
	
	public HttpResponse(OutputStream outputStream) {		// 获取outputStream
	...
	public String getContrntType() {
		return contentType;
	}

	public void setContrntType(String contrntType) {
		this.contentType = contrntType;
	}
